...
```json
{
  ...
  "updatedPlan": {
    ...
    "createdAt": 1742919315350,
    "updatedAt": 1742919315350,
    "steps": [
      {
        "id": "step_1_1742919315350",
        "description": "Determine the destination for the trip.",
        "assignedAgent": "planning",
        "completed": false
      },
      {
        "id": "step_2_1742919315350",
        "description": "Attempt to gather accommodation options in Paris from the provided URLs.",
        "assignedAgent": "browser",
        "completed": false,
        "dependsOn": [
          "step_1_1742919315350"
        ]
      },
      {
        "id": "step_3_1742919315350",
      ...
      {
        "id": "step_6_1742919315350",
        "description": "Create a daily itinerary for the 3-day trip, including activities, dining, and rest periods.",
        "assignedAgent": "planning",
        "completed": false,
        "dependsOn": [
          "step_2_1742919315350",
          "step_3_1742919315350",
          "step_4_1742919315350",
          "step_5_1742919315350"
        ]
      },
      {
        "id": "step_7_1742919315350",
